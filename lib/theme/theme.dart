...
class AppTheme {
  ...
  /// 主品牌色 - WeChat Green (Updated from #00A86B to #07C160)
  static const Color brandPrimary = Color(0xFF07C160);

  /// 品牌渐变色（深绿到浅绿）
  static const Color brandGradientStart = Color(0xFF09D46D);
  static const Color brandGradientEnd = Color(0xFF07C160);

  /// 次要品牌色
  static const Color brandSecondary = Color(0xFF07C160);

  /// 品牌色-浅色变体（用于背景、hover等）
  static const Color brandLight = Color(0xFFE7F8F0);
  static const Color brandLighter = Color(0xFFF4FBF8);

  /// 品牌色-深色变体（用于按压、active等）
  static const Color brandDark = Color(0xFF06AE56);
  ...
  /// 背景色系统 (Updated to WeChat Standards)
  ...
  /// 文本色系统（Updated to WeChat Standards）
  static const Color textPrimary = Color(0xFF111111); // 主文本 (Almost Black)
  static const Color textSecondary = Color(0xFF808080); // 次要文本 (Grey)
  ...
  /// 边框色系统 (Updated to WeChat Standards)
  static const Color border = Color(
    0xFFD5D5D5,
  ); // WeChat standard divider/border
  static const Color borderLight = Color(0xFFF0F0F0); // 浅色边框
  static const Color borderDark = Color(0xFFD5D5D5); // WeChat border

  /// 分割线
  static const Color divider = Color(0xFFD5D5D5); // WeChat divider
  ...
  /// 品牌渐变（主按钮） - Updated to WeChat Green
  static const LinearGradient gradientBrand = LinearGradient(
    colors: [Color(0xFF09D46D), Color(0xFF07C160)],
  ...
  static const LinearGradient gradientBackground = LinearGradient(
    colors: [Color(0xFFEDEDED), Color(0xFFFFFFFF)],
